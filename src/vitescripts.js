...
//still used for subscriptions
//const connection = new WS_RPC('wss://buidl.vite.net/gvite/ws'); // testnet node
const connection = new WS_RPC('wss://node-tokyo.vite.net/ws'); // mainnet
const provider = new ViteAPI(connection, () => {
    console.log("client connected");
});

//viteconnect used for funding / guessing
...
//    await block.autoSetPreviousAccountBlock()
    ...
    //block.accountBlock.accountAddress = block.accountBlock.address // don't know why
    //console.log(block.accountBlock)
    //block.accountBlock.params = params
